      ...
      <div className="p-10">
        <div className="container mx-auto px-4">
          <div className="">
            <div className="w-full px-4">
              <div className="mb-12 lg:mb-20">
                <h2 className="mb-4 text-center text-4xl font-semibold text-gray-800">
          ...
          <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {/* 1th item */}
            <div data-aos="zoom-in" data-aos-duration="1500" aria-label="card servicio" className="mb-12 group wow fadeInUp border-2 border-secondaryColor border-opacity-50  rounded-2xl p-4 shadow-lg">
              ...
              <p className="text-xs text-justify">
                Ofrecemos soluciones de desarrollo de software personalizados que se adaptan perfectamente a las necesidades de su organización. Creamos productos digitales, que abarcan desde aplicaciones de escritorio hasta programas grandes que ayuden al funcionamiento administrativo, aplicaciones móviles nativas, aplicaciones web, y soluciones multiplataforma, entre otras.
              </p>
            </div>
            ...
            <div data-aos="zoom-in" data-aos-duration="1500" aria-label="card servicio" className="mb-12 group wow fadeInUp border-2 border-secondaryColor border-opacity-50  rounded-2xl p-4 shadow-lg">
              ...
              <p className="text-xs text-justify">
                Brindamos la dirección necesaria a tu a su empresa. Nuestras áreas principales de consultoría abarcan Tecnologías de la Información (TI), Computación en la Nube, etc. estamos disponibles para responder cualquier pregunta o preocupación que puedas tener.
              </p>
            </div>
            ...
            <div data-aos="zoom-in" data-aos-duration="1500" aria-label="card servicio" className="mb-12 group wow fadeInUp border-2 border-secondaryColor border-opacity-50  rounded-2xl p-4 shadow-lg">
              ...
              <p className="text-xs text-justify">
                Nosotros trabajamos por estar a la vanguardia de la revolución tecnológica, y estamos dispuestos a compartir nuestro conocimiento con su empresa para contribuir a la mejora de sus productos y servicios digitales.
              </p>
            </div>

            {/* 4th item */}
            <div data-aos="zoom-in" data-aos-duration="1500" aria-label="card servicio" className="mb-12 group wow fadeInUp border-2 border-secondaryColor border-opacity-50 rounded-3xl p-4 shadow-lg">
              <div className="flex justify-center">
                <div className="w-[70px] h-[70px] flex items-center justify-center bg-primaryColor rounded-2xl mb-8 relative z-10">
                  <span
                    className=" w-[70px] h-[70px] flex items-center justify-center bg-primaryColor bg-opacity-30 rounded-2xl mb-8 absolute z-[-1] top-0 left-0 rotate-[25deg] group-hover:rotate-45 duration-300"></span>
              ...
              <p className="text-xs text-justify">
                Hacemos más que simplemente desarrollar soluciones web y móviles. Nuestro equipo ofrece una serie de servicios relacionados con el desarrollo que incluyen pruebas de control de calidad, gestión de proyectos y más.
              </p>
            </div>
          </div>

          <div>
            <h3 className='text-center text-xl lg:text-2xl font-semibold'>¡Si tienes una necesidad digital, Nexus está aquí para ayudarte a resolver el problema!</h3>
          </div>
